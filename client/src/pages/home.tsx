...
export default function Home() {
  ...
  useEffect(() => {
    const unviewedAchievement = achievements.find(achievement => !achievement.isViewed);
  ...
  const aiRecommendation: AIRecommendation = {
    message: "Based on your last push session, let's focus on shoulders today. Your lateral raises showed great progress - time to challenge those delts!",
      ...
      <main className="pb-20 min-h-screen">
            ...
            <Link href={`/workout-journal/${ongoingWorkout.id}`}>
              ...
              >
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <span className="text-lg font-semibold max-w-[350px] truncate">Resume "{ongoingWorkout.name}"</span>
                </div>
              </Button>
            </Link>
          ) : (
        ...
        <section className="px-4 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/workouts">
              <Button variant="ghost" size="sm" className="text-duolingo-blue hover:text-duolingo-blue/80">
                View All
              </Button>
            </Link>
          </div>
            ...
            {recentWorkouts.length > 0 ? (
              ...
              <Card className="border-dashed border-2 border-gray-200">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="font-medium text-gray-900 mb-1">No workouts yet</h4>
                  <p className="text-sm text-gray-500 mb-3">Start your first workout to see it here!</p>
                  <Link href="/workout-journal">
            ...
            {goals.length > 0 ? (
              goals.slice(0, 2).map((goal) => {
                ...
                const getStatusColor = () => {
                  if (progress >= 80) return "bg-success-green/10 text-success-green";
                  if (progress >= 50) return "bg-warning-orange/10 text-warning-orange";
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <Badge className={getStatusColor()}>
                          {progress >= 80 ? "On Track" : progress >= 50 ? "Needs Focus" : "Getting Started"}
                        </Badge>
                      </div>
