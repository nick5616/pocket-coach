...
export default function Home() {
  ...
  const todayStats = {
    ...
    exercises: todaysWorkouts.reduce((acc, w) => acc + (w.exercises?.length || 0), 0),
  };
      ...
      <header style={{
        ...
        <div className="container">
          <div style={{ marginBottom: 'var(--spacing-lg)' }}>
            <h1 className="text-heading-1" style={{ color: 'white', marginBottom: 'var(--spacing-xs)' }}>
              Welcome back! 💪
            </h1>
        ...
        <div className="container" style={{ paddingTop: 'var(--spacing-xl)' }}>
          ...
          {inProgressWorkout && (
            <div style={{ marginBottom: 'var(--spacing-xl)' }}>
              <Link href={`/workout-journal/${inProgressWorkout.id}`} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  <div style={{ position: 'relative', zIndex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <div style={{ flex: 1 }}>
                        ...
                        <h3 className="text-heading-3" style={{ color: 'white', marginBottom: 'var(--spacing-xs)' }}>
          ...
          <section style={{ marginBottom: 'var(--spacing-xl)' }}>
            <h2 className="text-heading-2" style={{ marginBottom: 'var(--spacing-lg)' }}>Today's Progress</h2>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 'var(--spacing-md)' }}>
              ...
              <div className="stat-card">
                <div className="stat-value">{Math.round(todayStats.duration / 60)}</div>
          ...
          {/* Main Actions */}
          <section style={{ marginBottom: 'var(--spacing-xl)' }}>
            <h2 className="text-heading-2" style={{ marginBottom: 'var(--spacing-lg)' }}>Quick Start</h2>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
              {activeProgram ? (
                <Link href="/workout-journal" style={{ textDecoration: 'none' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <div style={{ display: 'flex', alignItems: 'center' }}>
                        <div style={{
                          ...
                          <Target style={{ width: '1.5rem', height: '1.5rem', color: 'var(--primary-600)' }} />
                        </div>
                        <div>
                      ...
                      <div style={{
                        ...
                        <Play style={{ width: '0.875rem', height: '0.875rem', fill: 'white' }} />
                      </div>
                    </div>
                  </div>
                </Link>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <div style={{ display: 'flex', alignItems: 'center' }}>
                        <div style={{
                          ...
                          <Plus style={{ width: '1.5rem', height: '1.5rem', color: 'var(--primary-600)' }} />
                        </div>
                        <div>
                          <h3 className="text-heading-3" style={{ marginBottom: 'var(--spacing-xs)' }}>
                            Start New Workout
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                      <div style={{
                        ...
                        <Calendar style={{ width: '1.5rem', height: '1.5rem', color: 'var(--secondary-600)' }} />
                      </div>
                      <div>
                        <h3 className="text-heading-3" style={{ marginBottom: 'var(--spacing-xs)' }}>
                          Browse Programs
                    ...
                    <ChevronRight style={{ width: '1rem', height: '1rem', color: 'var(--gray-400)' }} />
                  </div>
                </div>
              </Link>
            </div>
          ...
          {goals.length > 0 && (
            <section style={{ marginBottom: 'var(--spacing-xl)' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 'var(--spacing-lg)' }}>
                ...
                <Link href="/progress" className="text-body" style={{ color: 'var(--primary-600)', textDecoration: 'none' }}>
                  View All
                </Link>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
          ...
          {completedWorkouts.length > 0 && (
            <section>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 'var(--spacing-lg)' }}>
                ...
                <Link href="/workouts" className="text-body" style={{ color: 'var(--primary-600)', textDecoration: 'none' }}>
                  View All
                </Link>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
                {completedWorkouts.slice(0, 3).map((workout) => (
                  <Link key={workout.id} href={`/workout-journal/${workout.id}`} style={{ textDecoration: 'none' }}>
                    <div className="card" style={{ 
                      padding: 'var(--spacing-lg)',
                      cursor: 'pointer',
                      transition: 'all 0.2s ease'
