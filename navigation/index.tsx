...
function BottomTabNavigator() {
  ...
  return (
    <BottomTab.Navigator
      initialRouteName="CurrentWorkout"
      screenOptions={{
      ...
      <BottomTab.Screen
        ...
        options={({ navigation }: RootTabScreenProps<'CurrentWorkout'>) => ({
          title: 'Current Workout',
          tabBarIcon: ({ color }) => <TabBarIconFA name="dumbbell" color={color} />,
          headerRight: () => (
            <Pressable
      ...
      <BottomTab.Screen
        ...
        options={{
          title: 'Program',
          tabBarIcon: ({ color }) => <TabBarIconM name="notebook" color={color} />,
        }}
      />
    </BottomTab.Navigator>
  );
